package com.example.nicecalculator
...
class MainActivity : AppCompatActivity() {
    ...
    //used to know if the lastly pressed key
    var lastNumeric: Boolean = false

    //  if false, allow to add another DOT
    ...
    fun onDigit(view: View) {
        ...
        showInput.append((view as Button).text)
   ...
   //append operation
    fun onOperator(view: View) {
        if (lastNumeric && !isOperatorAdded(showInput.text.toString())) {
            showInput.append((view as Button).text)
            lastNumeric = false
            lastDot = false
        }
    ...
    fun onEqual(view: View) {
        ...
        if (lastNumeric) {
            ...
            var value = showInput.text.toString()
            var prefix = ""
            try {
                ...
                if (value.contains("/")) {
                    ...
                    showInput.text = removeZeroAfterDot((one.toDouble() / two.toDouble()).toString())
